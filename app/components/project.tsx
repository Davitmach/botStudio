    ...
    return(
        <div className="project_container flex flex-col max-w-[2000px] mx-auto px-[58px] gap-[68px] mb-[48px]">
            ...
            <div className="flex overflow-x-auto overflow-y-hidden gap-[15px]  pb-[68px] projects">
                <div className=" shrink-0 w-[428px]">
                    <div className="w-full h-[284px] img"><img className="object-contain w-full h-full" src="/banner1.png" alt="" /></div>
                    <div className="flex flex-col gap-[2px]">
                        <h1 className="text-[#333333] text-[25px] font-[700]">Бот для продажи контента</h1>
                ...
                <div className=" shrink-0 w-[428px]">
                    <div className="w-full h-[284px] img"><img className="object-contain w-full h-full" src="/banner2.png" alt="" /></div>
                    <div className="flex flex-col gap-[2px]">
                        <h1 className="text-[#333333] text-[25px] font-[700]">ИИ-ассистент</h1>
                ...
                <div className=" shrink-0 w-[428px]">
                    <div className="w-full h-[284px] img"><img className="object-contain w-full h-full"  src="/banner3.png" alt="" /></div>
                    <div className="flex flex-col gap-[2px]">
                        <h1 className="text-[#333333] text-[25px] font-[700]">Сбор лидов из чатов</h1>
                ...
                <div className=" shrink-0 w-[428px]">
                    <div className="w-full h-[284px] img"><img className="object-contain w-full h-full" src="/banner4.png" alt="" /></div>
                    <div className="flex flex-col gap-[2px]">
                        <h1 className="text-[#333333] text-[25px] font-[700]">Бот-Фотобудка</h1>
                ...
                <div className=" shrink-0 w-[428px]">
                    <div className="w-full h-[284px] img"><img className="object-contain w-full h-full" src="/banner5.png" alt="" /></div>
                    <div className="flex flex-col gap-[2px]">
                        <h1 className="text-[#333333] text-[25px] font-[700]">Бот для 3x-ui</h1>
