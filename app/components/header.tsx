...
export const Header = () => {
  ...
  <div className="logo font-[600] text-[33px] font-[Mont] ">Bot Studio</div>
  <div className="menu">
    <ul className="flex items-center gap-[60px]">
      <li><h1  onClick={()=>HandleScroll('#banner') }   className=" cursor-pointer text-[#000000] font-[600] font-[Mont]  text-[18.71px]">О студии</h1></li>
      <li><h1 onClick={()=>HandleScroll('#project') }  className=" cursor-pointer text-[#000000] font-[600] font-[Mont] text-[18.71px]">Готовые решения</h1></li>
      <li><h1 onClick={()=> HandleScroll('#posib')}  className=" cursor-pointer text-[#000000] font-[600] font-[Mont] text-[18.71px]">Возможности</h1></li>
    </ul>
  </div>
...
<div style={{
  ...
  <div>
    <ul className="flex flex-col items-center gap-[15px]">
        <li><h1 onClick={()=> HandleScroll('#banner')}  className="text-black text-[18px] cursor-pointer">О студии</h1></li>
        <li><h1  onClick={()=>HandleScroll('#project') }  className="text-black text-[18px] cursor-pointer">Готовые решения</h1></li>
        <li><h1  onClick={()=>HandleScroll('#posib') }  className="text-black text-[18px] cursor-pointer">Возможности</h1></li>
    </ul>
  </div>
  <div className="flex items-center flex-col gap-[20px]">
    ...
    <div className="flex gap-[6px] items-center cursor-pointer " onClick={()=> {
