export const Banner = ()=> {
    return(
      <div className="relative banner_container max-w-[2000px] w-full mx-auto px-[58px] pt-[165px] pb-[178px] flex flex-col gap-[25px]">
        ...
        <div className="flex items-center gap-[16px] contacts">
            <button className="bg-[#0F72EB] btn text-[15px] font-[600] rounded-[22px] py-[11px] px-[42px] text-white">Оставить заявку</button>
