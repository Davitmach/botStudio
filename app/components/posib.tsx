...
export const Posib = ()=> {
    ...
    return(
       ...
       <span className="gradient"> Bot Studio</span></h1></div>
        ...
        <div><h1 onClick={()=> {
            HandleScroll('#mail')
        }} className=" text-[#0F72EB] cursor-pointer text-[15px] font-[Mont] font-[700]  -translate-y-[-8px]" >Заказать</h1></div> 
        </div>
        <div className="bg-white w-full justify-start hover:shadow-2xl duration-500  rounded-[12px] h-full py-[22px] px-[20px] flex flex-col ">
...
мы возьмем на себя   </p>
        ...
        <div><h1 onClick={()=> {
            HandleScroll('#mail')
        }} className="font-[700] cursor-pointer font-[Mont] text-[#0F72EB] text-[15px] -translate-y-[-8px]">Заказать</h1></div> 
        </div>
        </div>
    </div>
    )
